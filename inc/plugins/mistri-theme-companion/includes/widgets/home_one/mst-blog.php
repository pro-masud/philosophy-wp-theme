...
class Mistri_Blog_Section_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
			...
			[
				'name' => 'mistri_post_background_color',
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .blog.sub-bg',
			]
		);
        ...
        $this->add_control(
			'mistri_blog_post_desc_color',
			[
				'label' => esc_html__('Desceription Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item .content p'  => 'color: {{VALUE}}'
                ],
                'separator' => 'before'
			]
		);
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'mistri_blog_post_desc_typography',
				'selector' => '{{WRAPPER}} .blog .item .content p',
			]
		);

        $this->add_control(
			'mistri_blog_post_btn_text_color',
			[
				'label' => esc_html__('Button Text Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item a.btn-two span'  => 'color: {{VALUE}}',
                    '{{{WRAPPER}}} .blog .item a.btn-two i'  => 'color: {{VALUE}}',
                ],
                'separator' => 'before'
			]
		);
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'mistri_blog_post_btn_text_typography',
				'selector' => '{{WRAPPER}} .blog .item a.btn-two, .blog .item a.btn-two i',
			]
		);

        $this->add_control(
			'mistri_blog_post_btn_border_color',
			[
				'label' => esc_html__('Button Border Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item a.btn-two'  => 'border-color: {{VALUE}}',
                ],
			]
		);

        $this->add_control(
			'mistri_blog_post_btn_bg_color',
			[
				'label' => esc_html__('Button Background Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item .btn-two'  => 'background-color: {{VALUE}}',
                ],
			]
		);

        $this->add_control(
			'mistri_blog_post_by_color',
			[
				'label' => esc_html__('By Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item .info strong'  => 'color: {{VALUE}}',
                ],
                'separator'     => 'before'
			]
		);
        ...
        $this->add_control(
			'mistri_blog_post_author_color',
			[
				'label' => esc_html__('Author Info Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item .info a'  => 'color: {{VALUE}}',
                    '{{{WRAPPER}}} .blog .item .info span'  => 'color: {{VALUE}}',
                ],
			]
		);
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'mistri_blog_post_author_typography',
				'selector' => '{{WRAPPER}} .blog .item .info a, .blog .item .info span',
			]
		);

        $this->add_control(
			'mistri_blog_post_background_color',
			[
        ...
        $this->add_control(
			'mistri_blog_post_desc_hover_color',
			[
				'label' => esc_html__('Desceription Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item:hover .content p'  => 'color: {{VALUE}}'
                ],
                'separator' => 'before'
			]
		);
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'mistri_blog_post_desc_hover_typography',
				'selector' => '{{WRAPPER}} .blog .item:hover .content p',
			]
		);

        $this->add_control(
			'mistri_blog_post_btn_text_hover_color',
			[
				'label' => esc_html__('Button Text Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item:hover a.btn-two span'  => 'color: {{VALUE}}',
                    '{{{WRAPPER}}} .blog .item:hover a.btn-two i'  => 'color: {{VALUE}}',
                ],
                'separator' => 'before'
			]
		);
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'mistri_blog_post_btn_text_hover_typography',
				'selector' => '{{WRAPPER}} .blog .item:hover a.btn-two, .blog .item:hover a.btn-two i',
			]
		);

        $this->add_control(
			'mistri_blog_post_btn_border_hover_color',
			[
				'label' => esc_html__('Button Border Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item:hover a.btn-two'  => 'border-color: {{VALUE}}',
                ],
			]
		);

        $this->add_control(
			'mistri_blog_post_btn_bg_hover_color',
			[
				'label' => esc_html__('Button Background Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .btn-two::before'  => 'background-color: {{VALUE}}',
                ],
			]
		);

        $this->add_control(
			'mistri_blog_post_by_hover_color',
			[
				'label' => esc_html__('By Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item:hover .info strong'  => 'color: {{VALUE}}',
                ],
                'separator'     => 'before'
			]
		);
        ...
        $this->add_control(
			'mistri_blog_post_author_hover_color',
			[
				'label' => esc_html__('Author Info Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{{WRAPPER}}} .blog .item:hover .info a'  => 'color: {{VALUE}}',
                    '{{{WRAPPER}}} .blog .item:hover .info span'  => 'color: {{VALUE}}',
                ],
			]
		);
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'mistri_blog_post_author_hover_typography',
				'selector' => '{{WRAPPER}} .blog .item:hover .info a, .blog .item:hover .info span',
			]
		);
        
        $this->add_control(
			'mistri_blog_post_hover_background_color',
			[
				'label' => esc_html__('Box Background Color', 'mistri'),
				'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render() {
        ...
        if ($recent_posts->have_posts()) {
            ...
            echo '<section class="blog section-padding sub-bg">';
