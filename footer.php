    ...
    <div class="row top">
        ...
        <div class="col-eight md-six tab-full popular">
            ...
            <div class="block-1-2 block-m-full popular__posts">
                <?php
                $phososhpy_popular_post = new WP_Query(
                    [
                        "posts_per_page" => "6",
                        "ignor_stick_post" => "1",
                ...
                while ($phososhpy_popular_post->have_posts()){
                    ...
                    <article class="col-block popular__post">
                        ...
                        <section class="popular__meta">
                            <span class="popular__author"><span><?php echo _e('By', 'philosophy'); ?></span> <a href="<?php echo esc_url(get_author_posts_url($phososhpy_popular_post->ID));  ?>"> <?php the_author(); ?></a></span>
        ...
        <div class="row">
            <div class="col-full">
                <div class="s-footer__copyright">
                    ...
                    <span>Site Template by <a href="https://colorlib.com/">Colorlib</a> Distributed By <a
                            href="https://htmltemplates.co/">HTML Templates</a></span>
                </div>
